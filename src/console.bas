...
Private Sub ParseDictionary(Any_ As Variant, ByRef EncodeStrings As Object, ByRef ObjectAddress As Object)
    ...
    If console.GetAndSetObjectAddress(Any_, ObjectAddress) Then
        Call EncodeStrings.Add(console.ObjectToString(Any_) & "{ Åc ]")
        Exit Sub
    End If
...
Public Sub Print2D(Any_ As Variant, Optional Head As Long = 10, Optional Tail As Long = 10)
    ...
    ' Add header string.
    Call DisplayStrings.Add(console.GetRuledLineString(ColsArray, RowStringIndexes, "Ñ¨Ñ±Ñ∂Ñ™Ñ≠"))
    Call DisplayStrings.Add(InfoRowString)
    Call DisplayStrings.Add(console.GetRuledLineString(ColsArray, RowStringIndexes, "Ñ∞Ñ¥ÑπÑ™Ñ≤"))
    ...
    For Each RowIndex In RowIndexes
        ...
        If Not RowIndex = LastRowIndex + 1 Then
            ...
            Call DisplayStrings.Add(console.GetRuledLineString(ColsArray, RowStringIndexes, "ÑµÑæÑ©ÑüÑ∑"))
            Call DisplayStrings.Add(InfoRowString)
            Call DisplayStrings.Add(console.GetRuledLineString(ColsArray, RowStringIndexes, "ÑµÑæÑ©ÑüÑ∑"))
        End If
    ...
    Call DisplayStrings.Add(console.GetRuledLineString(ColsArray, RowStringIndexes, "Ñ∞Ñ¥ÑπÑ™Ñ≤"))
    Call DisplayStrings.Add(InfoRowString)
    Call DisplayStrings.Add(console.GetRuledLineString(ColsArray, RowStringIndexes, "ÑØÑ≥Ñ∏Ñ™ÑÆ"))
...
Private Function GetDisplayRowString( _
    ...
    IndexString = "Ñ´" & RowStringIndexes(Index) & "Ñ´"
    
    GetDisplayRowString = IndexString & Join(RowStringArray, "Ñ†") & IndexString
